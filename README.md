...
| Changes: (1) Found issue with focal loss ! labels had values >1, which resulted in slightly weird loss terms  (2) Use mask through concatenation instead of through simply masking camera image (3) Significantly reduce image augmentation |                                    | Training was not complete, but had to hand in results due to deadline. regr_loss was 0.45 at the end, but I believe it would still have gone down further. |
|                                                              |                                    |                                                              |
